...
public class CadClienteHelper {
    ...
    public CadClienteHelper(CadClienteActivity activity) {
        ...
        fieldCep = (EditText) activity.findViewById(R.id.etCep);
    ...
    public Cliente getCliente() {
        ...
        Endereco end = new Endereco(cliente, city,
                ...
                fieldCep.getText().toString().trim().toUpperCase());
        enderecos.add(end);
    ...
    public String validaCampos() {
        ...
        String cep = fieldCep.getText().toString().trim();
