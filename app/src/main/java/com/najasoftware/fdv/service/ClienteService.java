    ...
    private List<Cliente> parserJson(String json) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < jsonClientes.length(); i++) {
                ...
                if(jsonCliente.getString("cep") != null){
                    endereco.setCep(jsonCliente.getString("cep"));
                }
    ...
    public String toJson(List<Cliente> clientes) {
        ...
        try {
            ...
            for (Cliente cliente : clientes) {
                ...
                jsonCliente.put("codigo_vendedor",cliente.getVendedorId());
                ...
                jsonEndereco.put("cep",cliente.getEnderecos().get(0).getCep());
